...
class ClassifiedsModule extends CWebModule {

	private $_assetsUrl;

	private $_version = "v0.1.0";
	private $_versionDate = "19/01/2018";
	private $_keywords = "market, annonce, classifieds, module,opensource,CO,communecter";
	private $_description = "Classifieds , Market Place module for CO";
	private $_pageTitle = "Classifieds modules & CO Systems";
